...
MIDDLEWARE = [
    ...
    'core.middleware.DatabaseConnectionMiddleware',  # Add this line
...
# CORS_ALLOW_ALL_ORIGINS = DEBUG  # Descomenta esta línea si necesitas permitir todos los orígenes en desarrollo
