...
export default function AyudaMedicaReportPage() {
  ...
  const statusData = [
    ...
    { label: 'Rechazada', count: 15, color: '#F87171' },
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Reportes de Ayuda Médica</h1>
          <p className="text-muted-foreground">
            Estadísticas y datos sobre las solicitudes de ayuda médica.
          </p>
        </div>
        <Button
          variant="outline"
        ...
        <TabsContent value="charts" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Análisis porcentual de solicitudes de ayuda médica por estado
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="timeline" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Evolución mensual de solicitudes de ayuda médica por estado
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[400px]">
