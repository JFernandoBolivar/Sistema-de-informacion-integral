...
export default function AyudaTecnicaReportPage() {
  const router = useRouter();

  // Sample data for technical assistance report
  const statusData = [
    { label: 'Pendiente', count: 15, color: '#FBBF24' },
    { label: 'Aprobada', count: 25, color: '#34D399' },
    { label: 'Rechazada', count: 8, color: '#F87171' },
    { label: 'Vencida', count: 5, color: '#8B5CF6' },
  ];
  ...
  const timelineData = {
    ...
    datasets: [
      {
        label: 'Pendientes',
        data: [12, 15, 10, 18, 14, 15],
        color: 'rgba(251, 191, 36, 0.5)',
        borderColor: 'rgb(251, 191, 36)',
      },
      {
        label: 'Aprobadas',
        data: [18, 22, 25, 20, 24, 25],
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Reportes de Ayuda Técnica</h1>
          <p className="text-muted-foreground">
            Estadísticas y datos sobre las solicitudes de ayuda técnica.
          </p>
        </div>
        <Button
          variant="outline"
        ...
        <TabsContent value="charts" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Análisis porcentual de solicitudes de ayuda técnica por estado
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="timeline" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Evolución mensual de solicitudes de ayuda técnica por estado
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[400px]">
